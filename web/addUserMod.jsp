    ...
    <body>
        <%
            ...
            String actualizacion = "UPDATE usuario SET "
                    + "nombre='" + request.getParameter("nombreUs")
                    + "', número=" + Integer.valueOf(request.getParameter("contraseña"))
                    + "' WHERE usuarioID=" + Integer.valueOf(request.getParameter("usuarioID"));
